...
<div class="container">
    <div class="py-5 text-center">
        ...
        <p class="lead">Complete your booking payment securely using SSLCommerz hosted checkout.</p>
    </div>
            ...
            <ul class="list-group mb-3">
                ...
                @forelse($orders ?? [] as $order)
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-0">{{ $order->package->title ?? 'N/A' }}</h6>
                            <small class="text-muted">{{ $order->package->category ?? '' }}</small>
                        </div>
                        <span class="text-muted">{{ $order->price ?? 0 }} TK</span>
                    </li>
                @empty
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="customer_zip" class="form-control" id="zip" value="1200" required>
                    </div>
                </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js"
        integrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGaMWjUbiZB7Q0Ut0J8HZ1z4U8"
        crossorigin="anonymous"></script>
